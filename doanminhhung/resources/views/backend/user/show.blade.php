        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-user active">Chi tiết sản phẩm</li>
            </ol>
          </div>
        </div>
        <div class="d-flex justify-content-end">
          <div class="">
            <a class=" btn btn-sm btn-primary"  href="{{ route('user.index') }}"><i class="fas fa-undo-alt"></i>Quay về danh sách</a>
   ...
   <table class="table table-bordered">
    <thead>
        ...
        <td class="fw-bold text-danger">Hình Ảnh</td>
          <td>
              <img width="50px" height="50px" src="{{ $user->image }}" alt="{{ $user->image }}">
          </td>
        </tr>
