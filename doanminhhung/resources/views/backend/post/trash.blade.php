                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-post"><a href="{{ route('dashboard.index') }}">Bảng điều khiển</a></li>
                            <li class="breadcrumb-post active">Thùng rác thương hiệu</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card-header">
                    <div class="row"> 
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <a href="{{ route('post.index') }}" class="btn bg-dark">
                    ...
                    <tbody>
                        @foreach ($post as $post)
                            <tr>
                                ...
                                <td class="text-center">
                                    <img class="img-fluid" src="{{ asset('image/post/' .$post->image) }}"
                                        alt="{{ $post->image }}">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('post.restore', ['post' => $post->id]) }}" {{-- đường dẫn khi nhấp vào edit có tham số truyền vào nên phải có ->id  --}}
