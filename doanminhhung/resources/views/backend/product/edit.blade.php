                            ...
                            <div class="row">
                                <div class="col-md-8 ">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="metakey" class="form-control" rows="3" placeholder="Nhập tên danh mục">{{$product->metakey}}"</textarea>
    
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Từ khóa</label>
                                        <textarea name="metades" class="form-control" rows="3" placeholder="Nhập tên danh mục">{{$product->metadesc}}"</textarea>
