                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-order"><a href="{{ route('dashboard.index') }}">Bảng điều khiển</a></li>
                            <li class="breadcrumb-order active">Thùng rác thương hiệu</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card-header">
                    <div class="row"> 
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <a href="{{ route('order.index') }}" class="btn bg-dark">
                    ...
                    <tbody>
                        @foreach ($order as $order)
                            <tr>
                                ...
                                <td class="text-center">
                                    <img class="img-fluid" src="{{ asset('image/order/' .$order->image) }}"
                                        alt="{{ $order->image }}">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('order.restore', ['order' => $order->id]) }}" {{-- đường dẫn khi nhấp vào edit có tham số truyền vào nên phải có ->id  --}}
