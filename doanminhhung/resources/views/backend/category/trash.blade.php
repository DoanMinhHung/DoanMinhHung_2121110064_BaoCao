                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-category"><a href="{{ route('dashboard.index') }}">Bảng điều khiển</a></li>
                            <li class="breadcrumb-category active">Thùng rác danh mục</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card-header">
                    <div class="row"> 
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <a href="{{ route('category.index') }}" class="btn bg-dark">
                    ...
                    <tbody>
                        @foreach ($categorys as $category)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('category.restore', ['category' => $category->id]) }}" {{-- đường dẫn khi nhấp vào edit có tham số truyền vào nên phải có ->id  --}}
